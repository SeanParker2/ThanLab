...
const workData: { [key: number]: WorkDetail } = {
  1: {
    ...
    title: '品牌视觉系统',
    category: '品牌设计',
    description: '为现代企业打造独特的品牌视觉识别系统',
    fullDescription: '这是一个为科技创新企业设计的完整品牌视觉系统项目。我们从品牌核心价值出发，创造了一套现代、简洁且具有科技感的视觉语言，涵盖了从logo设计到应用系统的全方位品牌体验。',
    client: 'TechFlow 科技公司',
    year: '2024',
    services: ['品牌策略', 'Logo设计', '视觉识别系统', '应用设计', '品牌指南'],
    challenge: '客户是一家快速发展的科技公司，需要建立专业且具有创新感的品牌形象，以在竞争激烈的市场中脱颖而出。原有的品牌形象缺乏统一性和专业度，无法有效传达公司的技术实力和创新精神。',
    solution: '我们采用了极简主义的设计理念，以几何图形为基础，创造了一个既现代又具有科技感的logo。整个视觉系统使用了蓝色和灰色的配色方案，传达专业性和可靠性。同时，我们设计了完整的应用规范，确保品牌在各种媒介上的一致性表现。',
    result: '新的品牌视觉系统成功提升了客户的品牌认知度，在推出后的6个月内，品牌知名度提升了40%，客户满意度达到95%。该项目还获得了当年的设计大奖认可。',
    images: ['work_1_1.png', 'work_1_2.png', 'work_1_3.png', 'work_1_4.png'],
  ...
  2: {
    ...
    title: '现代空间美学',
    category: '空间设计',
    description: '融合功能与美学的现代居住空间设计',
    fullDescription: '这是一个现代住宅的室内设计项目，我们致力于创造一个既实用又美观的生活空间。设计理念强调自然光线的运用、开放式布局和可持续材料的选择，为居住者提供舒适且具有美感的生活环境。',
    client: '私人住宅业主',
    year: '2024',
    services: ['空间规划', '室内设计', '家具选配', '照明设计', '材料选择'],
    challenge: '原有空间布局不合理，采光不足，储物空间有限。业主希望在有限的空间内实现开放感，同时满足一家四口的日常生活需求，并体现现代简约的美学追求。',
    solution: '我们重新规划了空间布局，拆除了部分非承重墙，创造了开放式的客厅、餐厅和厨房区域。使用大面积的玻璃窗和天窗增加自然采光，选择浅色调的材料和家具来增强空间感。同时，设计了多功能储物解决方案，最大化利用每一寸空间。',
    result: '改造后的空间不仅满足了业主的所有功能需求，还创造了一个充满现代美感的生活环境。业主对最终效果非常满意，该项目也成为了我们空间设计作品集中的代表作品。',
    images: ['work_2_1.png', 'work_2_2.png', 'work_2_3.png', 'work_2_4.png'],
    color: 'from-green-500 to-blue-500',
    tags: ['室内设计', '空间规划', '现代风格', '住宅']
  },
  3: {
    id: 3,
    title: '产品包装设计',
    ...
    images: ['work_3_1.png', 'work_3_2.png', 'work_3_3.png', 'work_3_4.png'],
  ...
  4: {
    ...
    images: ['work_4_1.png', 'work_4_2.png', 'work_4_3.png', 'work_4_4.png'],
  ...
  5: {
    ...
    images: ['work_5_1.png', 'work_5_2.png', 'work_5_3.png', 'work_5_4.png'],
  ...
  6: {
    ...
    images: ['work_6_1.png', 'work_6_2.png', 'work_6_3.png', 'work_6_4.png'],
